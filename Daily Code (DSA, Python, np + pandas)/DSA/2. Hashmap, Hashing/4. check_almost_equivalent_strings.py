...
"""
Immediately went for collections.Counter, no help needed.

* One can perform set operations on counter dicts
* If a key is not present -> it's count is zero.
...
def check_almost_equivalent(word1: str, word2: str) -> bool:
    ...
    word_set = set(word1 + word2)

    for word in word_set:
        if abs(count1[word] - count2[word]) > 3:
            return False
...
print(check_almost_equivalent(word1, word2))
